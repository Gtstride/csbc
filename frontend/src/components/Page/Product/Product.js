            ...
            <div className="container">
              <div className="row product-flex">
                    ...
                    <div className="clearfix">
                      ...
                      <div className="info-box">
                        ...
                        <span className="hidden">
                          <i className="fa fa-truck" /> Out of stock
                        </span>
                      </div>
                      <hr />
                      <div className="info-box info-box-addto added">
                        ...
                        <span>
                          ...
                          <i className="added">
                            <i className="fa fa-heart" /> Remove from favorites
                          </i>
                        </span>
                      </div>
                      <div className="info-box info-box-addto">
                        ...
                        <span>
                          <i className="add">
                            <i className="fa fa-eye-slash" /> Add to Watch list
                          </i>
                          <i className="added">
                            <i className="fa fa-eye" /> Remove from Watch list
                          </i>
                        </span>
                      </div>
                      <div className="info-box info-box-addto">
                        ...
                        <span>
                          <i className="add">
                            <i className="fa fa-star-o" /> Add to Collection
                          </i>
                          <i className="added">
                            <i className="fa fa-star" /> Remove from Collection
                          </i>
                        </span>
                      </div>
                      <hr />
                ...
                <div className="col-md-8 col-sm-12 product-flex-gallery">
                  {/* === add to cart === */}
                  <button type="submit" className="btn btn-buy" data-text="Buy" />
                  {/* === product gallery === */}
                  <div className="owl-product-gallery open-popup-gallery">
                    <a href="assets/images/product-1.png">
                      <img src="assets/images/product-1.png" alt height={500} />
                    </a>
                    <a href="assets/images/product-2.png">
                      <img src="assets/images/product-2.png" alt height={500} />
                    </a>
                    <a href="assets/images/product-3.png">
                      <img src="assets/images/product-3.png" alt height={500} />
                    </a>
                    <a href="assets/images/product-4.png">
                      <img src="assets/images/product-4.png" alt height={500} />
                    </a>
                  </div>
                </div>
              </div>
                      ...
                      <div className="name">
                        ...
                        <p>
                          <a href="mailto:johndoe@mail.com">
                            <i className="icon icon-envelope" /> johndoe@mail.com
                          </a>
                        </p>
                        <p>
                          <a href="tel:002255858">
                            <i className="icon icon-phone-handset" /> +002255858
                          </a>
                        </p>
                        <p>
                                ...
                                <div className="figure-grid">
                                  ...
                                  <div className="text">
                                    ...
                                    <span className="description clearfix">
                                      ...
                                      facilisis blandit et aliquyam lorem ea duo
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            ...
                            <p>
                              ...
                              your family is sure to love. The plush pillows and soft
                              sloped arms create the ultimate combination for
                            ...
                            <p>
                              Sofa is fun and elegant with beauty and style that will
                              stay cutting-edge trendy through the years. It is
                              completely padded, including the back and outside arms -
                              combining comfort and value to make rewarding relaxatio.
                            </p>
                          </div>
                        </div>{" "}
                        {/*/row*/}
                          ...
                          <div className="col-md-12">
                            <div className="comments">
                                ...
                                <div className="comment-block">
                                  ...
                                  <div className="comment-block">
                                    <div className="comment-user">
                                      ...
                                      <div>
                                        <h5>
                                          Administrator<small>08.05.2017</small>
                                        </h5>
                                      </div>
                                    </div>
                                    <div className="comment-desc">
                              ...
                              <div className="comment-header">
                                <a href="#" className="btn btn-clean-dark">
                                  12 comments
                                </a>
                              </div>{" "}
                              {/*/comment-header*/}
